...
3. Check the **"Run Shell Script"** action:
   ...
   - **Script:** Should contain:
     ```bash
     /path/to/home/Projects/Sakura\ Sumi/scripts/compress_with_defaults.sh "$@"
     ```
     OR if using relative path:
     ```bash
     cd "/path/to/home/Projects/Sakura Sumi"
...
```bash
/path/to/home/Projects/Sakura\ Sumi/scripts/compress_with_defaults.sh '/path/to/home/Downloads/your-folder-name'
```
...
3. Verify the script is executable: `chmod +x /path/to/home/Projects/Sakura\ Sumi/scripts/compress_with_defaults.sh`
