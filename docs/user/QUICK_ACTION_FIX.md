...
2. **Test the script directly:**
   ```bash
   /path/to/home/Projects/Sakura\ Sumi/scripts/compress_quick_action.sh '/path/to/home/Projects/your-folder'
   ```
...
4. **Check permissions:**
   ```bash
   chmod +x /path/to/home/Projects/Sakura\ Sumi/scripts/compress_quick_action.sh
   ```
