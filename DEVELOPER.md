# Developer Guide - OCR Compression System

Welcome to the OCR Compression project! This guide will help you get started as a developer.

## 🎨 Project Overview

The OCR Compression System converts codebases into compressed PDFs optimized for LLM analysis. The system features a beautiful **sakura-themed web portal** with cherry blossom aesthetics, falling petal animations, and a modern, intuitive interface.
